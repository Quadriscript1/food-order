...
if (isset($_GET['food_id'])) {
    ...
    //count the number of row in the result set
    $count = mysqli_num_rows($res);

    //check if the rows is available
    if ($count == 1) {
        //rows available
    ...
    <div class="container">
        ...
        <form action="" method="POST" class="order">
            ...
            <fieldset>
                ...
                <input type="email" name="email" placeholder="E.g. hi@youremail.com" class="input-responsive" required>
        ...
        <?php
            ...
            if(isset($_POST['submit'])){
                ...
                if($res2 == true){
                    ...
                    //query executed and order saved to database
